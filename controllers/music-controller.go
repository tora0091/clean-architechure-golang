...
func (controller *musicController) FindAll(c *gin.Context) {
	...
	c.JSON(http.StatusOK, jsons.ResponseMusicList{Data: musics})
}
...
func (controller *musicController) Save(c *gin.Context) {
	...
	c.JSON(http.StatusOK, jsons.ResponseMusic{Data: music})
}
...
func (controller *musicController) FindAllData(c *gin.Context) {
	...
	c.JSON(http.StatusOK, jsons.ResponseMusicListStructResponse{Data: musics})
}
...
func (controller *musicController) SaveAllData(c *gin.Context) {
	...
	c.JSON(http.StatusOK, jsons.ResponseMusicStructResponse{Data: music})
}
